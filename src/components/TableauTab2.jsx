...
export default function TableauTabs() {
  ...
  return (
    <div>
      <h2 className="text-xl text-center font-bold text-white mb-4 p-6">REALISATION DES RECETTES BUDGETAIRE MENSUELLES DE L'ANNEE : <span className='text-back-300'>{formatDate(month)}</span>  </h2>
